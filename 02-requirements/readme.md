...
## Задача 1
👉 [Посмотреть мое решение](../02-requirements/portal-helpdesk/requirements.md)
...
👉 [Посмотреть мое решение](../02-requirements/portal-helpdesk/use-cases.md)
...
## Задача 2
👉 [Посмотреть мое решение](../02-requirements/ticket-bot/requirements.md)
